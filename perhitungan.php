            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="col-lg-7">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">PEMILIHAN SEKOLAH</h1>


                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <div class="panel-heading">
                                    Form Pemilihan Sekolah
                                </div>
                            </div>
                            <div class="card-body">
                                        ...
                                        <form action="perhitungan_hasil.php" method="post" name="form1">
                                            <table width="25%" border="0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="bobot_akreditasi" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="bobot_fasilitas" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="bobot_biaya_masuk" class="form-control">
                                                            <option value="1">Rp.<2.000.000 </option>
                                                            <option value="2">Rp.2000.0000-3.000.000</option>
                                                            <option value="3">Rp.3.000.000-6.000.000</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="bobot_uang_SPP" class="form-control">
                                                            <option value="1">Rp.100.000-200.000 </option>
                                                            <option value="2">Rp.200.000-300.000</option>
                                                            <option value="3">Rp.300.000-500.000</option>
                                                            <option value="4">Rp.>500.000 </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="bobot_prestasi" class="form-control">
                                                            <option value="1">Unggul</option>
                                                            <option value="2">Cukup unggul</option>
                                                            <option value="3">Kurang unggul</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label>Jarak</label>
                                                    <div>
                                                        <select name="bobot_jarak" class="form-control">
                                                            <option value="1">1-5 km</option>
                                                            <option value="2">6-10 km</option>
                                                            <option value="3">11-25 km</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <tr>
