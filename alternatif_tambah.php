                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                        ...
                                        <form action="alternatif_tambah.php" method="post" name="form1">
                                            <table width="25%" border="0">
                                                <div class="form-group">
                                                    <label>NPSN</label>
                                                    <input type="text" class="form-control" name="id_sekolah" placeholder="NPSN" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="Biaya_masuk" placeholder="Biaya Masuk" />
                                                </div>
                                                <div class="form-group">
                                                    <label>Uang SPP</label>
                                                    <input type="text" class="form-control" name="Uang_SPP" placeholder="Uang SPP" />
                                                </div>
                                                <div class="form-group">
                                ...
                                if (isset($_POST['Submit'])) {
                                    ...
                                    $result = mysqli_query($connect, "INSERT INTO alternatif (id_sekolah, nama, Akreditasi, Fasilitas, Biaya_masuk, Uang_SPP, Prestasi, Jarak) VALUES('$id','$nama','$ak','$fas','$bia','$uan','$pre','$jar')");

                                    // $result = mysqli_query($connect, "INSERT INTO alternatif (id_sekolah, nama, Akreditasi) 
                                    // VALUES('','$nama','$akre')");
